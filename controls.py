import pygame, sys
from game_space.game_space.bullet import Bullet
from ino import Ino
import time
    ...
    for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_RIGHT:
                    ...
                    new_bellet = Bullet(screen, gun)
                    bullets.add(new_bellet)
...
def update_bullets(screen, stats, sc, inos, bullets):
    """бновление позиции пуль по оси у"""
    bullets.update()
